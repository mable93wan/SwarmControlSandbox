...
\end{overpic}
\vspace{-1em}
\caption{\label{fig:gain values} Tuning proportional ($K_p$, top) and derivative ($K_d$, bottom)  gain values improves performance. These plots show convergence with 100 robots.
%\vspace{-2em}
}
\end{figure}
