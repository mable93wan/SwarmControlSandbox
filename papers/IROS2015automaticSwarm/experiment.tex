...
=======
\vspace{-1em}
\caption{\label{fig:Failure}Algorithm \ref{alg:BlockPushing} fails when some robots are stuck in the maze and the swarm can not achieve $\sigma^2 < \sigma_{min}^2$.  These failures occur during 30\% of trials.
>>>>>>> origin/master
%\vspace{-2em}
}
\end{figure}
