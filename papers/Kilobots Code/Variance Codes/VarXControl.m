...
tHandle = timer('TimerFcn',...
    {@sqWave_callback_fcn, goal1x, goal2x,goalVarX1, goalVarX2,t0}, ...
...
function  sqWave_callback_fcn(src,evt, goal1x, goal2x,goalVarX1, goalVarX2,t0) %#ok<DEFNU>
