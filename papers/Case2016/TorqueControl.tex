...
Instead they are controlled by external signal such as a magnetic field. 
...
Previous work showed that mean and variance of the swarm is controllable. This enables manipulating simple objects through a simple maze. A key remaining challenge is controlling the torque applied to an object. 
Torque control is necessary for observing, emitting and manipulating objects.
This work first proves that torque control is possible, then presents algorithms to automate the task. 
