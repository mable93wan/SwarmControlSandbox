...
\paragraph{Follow linear trajectory with perpendicular orientation} \label{para:PureTranslation}
...
Different situations for position control of the block while controlling its orientation. The first task is pushing the object COM to a line perpendicular to the goal. The second task is to push the object along this perpendicular line while regulating the orientation.
}
\end{figure*}
