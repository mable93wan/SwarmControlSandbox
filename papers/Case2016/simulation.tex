...
\begin{figure}
\begin{center}
	\includegraphics[width=\columnwidth]{perpendicular.pdf}
\end{center}
\vspace{-1em}
...
\State $P_x = \frac{b(bO_x-aO_y)-ac}{a^2 + b^2}$  \Comment{Nearest point on line}
\State $P_y = \frac{a(-bO_x+aO_y)-bc}{a^2 + b^2}$
\While {$O_x <  P_x \wedge O_y < P_y $} \Comment{Reaching near the line}
