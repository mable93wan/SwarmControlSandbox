...
\title{Controlling Shape of a Swarm with Global Inputs}
%
%
...
\author{Shiva~Shahrokhi,~\IEEEmembership{Member,~IEEE,}
        
        and~Aaron~T.~Becker,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
\thanks{S. Shahrokhi and A. Becker is with the Department
of Electrical and Computer Engineering, University of Houston, Houston,
TX, 77025 USA e-mail: \{sshahrokhi2, atbecker\}@uh.edu}% <-this % stops a space
