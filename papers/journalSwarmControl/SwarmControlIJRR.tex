...
\title{\LARGE \bf Swarm Control With Global Inputs}
\author{Shiva Shahrokhi, Aaron T. Becker\thanks{S.\ Shahrokhi and A.\ Becker is with the Department of Electrical and Computer Engineering, University of Houston, Houston, TX, 77004 USA {\tt\small sshahrokhi@uh.edu,atbecker@uh.edu}
} %end thanks
} % end author block 
\maketitle
