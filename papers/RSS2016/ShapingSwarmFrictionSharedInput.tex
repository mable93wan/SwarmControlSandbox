...
This paper describes the set of stable configurations of a swarm in two canonical workspaces, a circle and a square. 
...
We conclude with efficient techniques to control the covariance of a swarm not possible without wall-friction. Hardware implementations with 97 robots, and simulations validate these results.
