...
\caption{Pushing the swarm against a circular boundary wall allows limited control of the shape of the swarm, as a function of the fill level $h$ and the commanded movement direction $\beta$. See interactive demonstration at [withheld for double-blind review].}
\label{fig:friction}
\end{center}
\end{figure*} 
