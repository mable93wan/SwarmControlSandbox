...
Friction is sufficient to control covariance of the swarm. Assume an open workspace with boundary friction. The wall has infinite friction for simplicity. Variance in $x$ axis would shrink if the swarm hit the 
