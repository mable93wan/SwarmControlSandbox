...
\caption{\label{fig:vascularNetwork}
Swarm of kilobots programmed to move toward the brightest light source the current covariance ellipse and mean are shown in red, the desired is shown in green.  Navigating a swarm using global inputs is challenging
